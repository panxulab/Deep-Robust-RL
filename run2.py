...
from algorithm.tabular.LSVI_SAC2 import *

parser=argparse.ArgumentParser()
parser.add_argument("--seed",type=int,default=0)
parser.add_argument("--rho",type=float,default=60)
...
rho_label="%g" % args.rho
if args.outdir is None:
	args.outdir=os.path.join("results","kl",f"rho_{rho_label}",f"seed_{args.seed}")

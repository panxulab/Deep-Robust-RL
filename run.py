...
from algorithm.tabular.LSVI_SAC import *
...
parser.add_argument("--rho",type=parse_rho,default=60)
...
rho_label="None" if args.rho is None else ("%g" % args.rho)
if args.outdir is None:
	args.outdir=os.path.join("results","tv",f"rho_{rho_label}",f"seed_{args.seed}")
...
def train():
	...
	agent=LSVI_SAC(state_dim=17,action_dim=6,rho=args.rho,action_space=env.action_space).to(device)
